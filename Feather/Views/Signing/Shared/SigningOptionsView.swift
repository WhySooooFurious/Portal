...
struct SigningOptionsView: View {
    ...
    var body: some View {
        ...
        NBSection(.localized("Archive & Compression")) {
            Picker(selection: $_compressionLevel) {
                ForEach(ZipCompression.allCases, id: \.rawValue) { level in
                    Text(level.label).tag(level.rawValue)
                }
            } label: {
                Label(.localized("Compression Level"), systemImage: "archivebox")
            }
        ...
        NBSection(.localized("Signing")) {
            Picker(selection: $options.signingOption) {
                ...
                Label(.localized("Signing Type"), systemImage: "signature")
            }
        }
        ...
        NBSection(.localized("Localization")) {
            _toggle(
